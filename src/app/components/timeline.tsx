            ...
            <VerticalTimeline >
                <div className={styles.relative} ref={ref}>
                    <LazyMotion features={domAnimation}>
                        <m.div className={styles.timeline_icon} animate={isVisible ? 'visible' : 'hidden'}
                            variants={iconVariants}>
                            <Image src='/icons/fenicio.png' width={60} height={60} alt='Fenicio work experience' />
                        </m.div>
                    </LazyMotion>
                    <LazyMotion features={domAnimation}>
                        <m.aside initial='hiddenLeft' animate={isVisible ? 'showLeft' : ''} variants={SlideInVariants} className={styles.timeline_box}>
                ...
                <div className={styles.box_right} >
                    <LazyMotion features={domAnimation}>
                        <m.div className={styles.timeline_icon_right} animate={isVisible ? 'visible' : 'hidden'}
                            variants={iconVariants}>
                            <Image src='/icons/flow.jpg' width={60} height={60} alt='FlowLabs work experience' />
                        </m.div>
                    </LazyMotion>
                    <LazyMotion features={domAnimation}>
                        <m.aside initial='hiddenRight' animate={isVisible ? 'showRight' : ''} variants={SlideInVariants} className={styles.timeline_box_right}>
                            <div className={styles.timeline_info}>
